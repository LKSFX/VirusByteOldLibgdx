...
public class ScreenshotFactory {
    ...
    public static void saveScreenshot() {
    	saveScreenshot(Gdx.graphics.getWidth(), Gdx.graphics.getHeight(), true);
    }
    public static void saveScreenshot(int width, int height, boolean invert){
        try{
            FileHandle fh;
            do{
                fh = new FileHandle("screenshot" + counter++ + ".png");
            } while (fh.exists());
            Pixmap pixmap = getScreenshot(0, 0, width, height, invert);
